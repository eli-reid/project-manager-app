<div class="space-y-6">
    <div>
        <h1 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Change Orders</h1>
        <p class="text-sm text-zinc-500 dark:text-zinc-400">Browse project change orders.</p>
    </div>
                    ...
                    @forelse ($changeOrders as $changeOrder)
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/40">
                            ...
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('change-orders.show', $changeOrder) }}" class="rounded-md border border-zinc-300 px-2.5 py-1.5 text-xs font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">View</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-10 text-center text-sm text-zinc-500 dark:text-zinc-400">No change orders available.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
