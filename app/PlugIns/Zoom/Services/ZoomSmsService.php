...
class ZoomSmsService implements SmsServiceContract
{
     ...
     */
    public function send(string $to, \App\Core\Notification\Contracts\SmsMessage $message): array
    {
        ...
        return $this->doSend($normalizedTo, $message->body(), tokenRefreshed: false);
    }
