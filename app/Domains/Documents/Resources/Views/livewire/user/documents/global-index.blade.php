<div class="mx-auto w-full max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
            @if ($project)
                <flux:heading size="xl" level="1">Project Documents</flux:heading>
                <flux:text class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Showing documents for {{ $project->name }}.</flux:text>
            @else
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-10 text-center text-sm text-zinc-500 dark:text-zinc-400">{{ $project ? 'No documents available for this project.' : 'No global documents available.' }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
