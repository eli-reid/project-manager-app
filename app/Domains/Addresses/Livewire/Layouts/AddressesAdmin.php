...
namespace App\Domains\Addresses\Livewire\Layouts;
...
class AddressesAdmin extends Component implements ProvidesDomainNavbar
{
    /**
    ...
    {
        return view('addresses::livewire.layouts.addresses-admin');
    }
}
