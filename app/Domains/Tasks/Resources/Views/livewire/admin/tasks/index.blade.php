                        ...
                        <tr wire:key="task-{{ $task->id }}">
                            ...
                            <td class="px-4 py-3 align-top">
                                <div class="flex items-center justify-end gap-2">
                                    @can('update', $task)
                                        <a href="{{ route('admin.tasks.edit', $task) }}" wire:navigate class="rounded-md border border-zinc-300 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-zinc-700 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">Edit</a>
                                    @endcan
                                    @can('delete', $task)
                                        <button type="button" wire:click="deleteTask('{{ $task->id }}')" wire:confirm="Delete this task?" class="rounded-md border border-red-300 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-red-700 hover:bg-red-50 dark:border-red-800 dark:text-red-300 dark:hover:bg-red-900/20">Delete</button>
                                    @endcan
                                </div>
                            </td>
                        </tr>
