...
class TasksServiceProvider extends ServiceProvider
{
    ...
    public function boot(PermissionRegistry $permissionRegistry): void
    {
        ...
        Livewire::component('app.domains.tasks.livewire.admin.tasks', \App\Domains\Tasks\Livewire\Admin\Tasks\Index::class);
        Livewire::component('app.domains.tasks.livewire.admin.tasks.form', \App\Domains\Tasks\Livewire\Admin\Tasks\Form::class);
