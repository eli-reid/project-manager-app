...
class TimecardReminderNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->markdown('timecards::emails.notifications.timecard-reminder', [
    ...
    public function toWebPush(object $notifiable, Notification $notification): WebPushMessage
    {
        ...
        return (new WebPushMessage)
            ...
            ->body('Please submit your pending timecard for week ending '.$weekEnding.'.')
            ->icon('/icon-192.png')
            ->badge('/icon-192.png')
            ->tag('timecard-reminder-'.(string) $this->timecard->id)
            ->data([
                'url' => route('timecards.show', $this->timecard),
                'key' => $this->notificationKey(),
                'timecard_id' => (string) $this->timecard->id,
