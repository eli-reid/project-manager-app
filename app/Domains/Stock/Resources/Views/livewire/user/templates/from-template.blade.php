<div class="mx-auto w-full max-w-4xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">Order from Template</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">Using: <span class="font-medium text-zinc-700 dark:text-zinc-300">{{ $template->name }}</span></p>
        </div>
        <a href="{{ route('stock-orders.templates.browse') }}" wire:navigate class="rounded-md border border-zinc-300 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-zinc-700 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">Back</a>
    </div>
    ...
    <form wire:submit="submit" class="space-y-6">
        ...
        <div class="flex items-center justify-end gap-2">
            <a href="{{ route('stock-orders.templates.browse') }}" wire:navigate class="rounded-md border border-zinc-300 px-4 py-2 text-sm font-semibold text-zinc-700 hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800">Cancel</a>
