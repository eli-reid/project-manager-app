<div class="w-full space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('admin.scheduler.settings.index') }}" class="inline-flex items-center rounded-lg border border-zinc-300 bg-white px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800">
                System &amp; Timing
            </a>
                ...
                <tbody class="divide-y divide-zinc-200 dark:divide-zinc-800">
                    @forelse ($tasks as $task)
                        ...
                        <tr wire:key="task-{{ $task->id }}">
                            ...
                            <td class="px-4 py-3 align-top">
                                <livewire:ui.row-actions-dropdown label="Scheduler task actions" width="w-44" :menu-height="220">
