...
class ScheduledTaskService
{
     ...
     */
    protected function calculateDailyNextRun(ScheduledTask $task, Carbon $baseTime, CarbonInterface $now): Carbon
    {
        $taskTimezone = $task->timezone ?? 'America/New_York';
     ...
     */
    protected function calculateWeeklyNextRun(ScheduledTask $task, Carbon $baseTime, CarbonInterface $now): Carbon
    {
     ...
     */
    protected function calculateMonthlyNextRun(ScheduledTask $task, Carbon $baseTime, CarbonInterface $now): Carbon
    {
     ...
     */
    protected function calculateYearlyNextRun(ScheduledTask $task, Carbon $baseTime, CarbonInterface $now): Carbon
    {
        $nextRun = $now->copy()
            ->month($task->month ?? 1)
     ...
     */
    protected function calculateSpecificDateNextRun(ScheduledTask $task, CarbonInterface $now): ?Carbon
    {
        $taskTimezone = $task->timezone ?? 'America/New_York';
