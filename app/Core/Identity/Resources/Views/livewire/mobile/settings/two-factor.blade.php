<section class="space-y-4 px-4 py-4">
    ...
    <div class="space-y-1">
        ...
        <flux:text class="text-zinc-400">{{ __('Manage your two-factor authentication settings') }}</flux:text>
    </div>

    <div class="rounded-2xl border border-zinc-800 bg-zinc-900 p-4" wire:cloak>
        @if ($twoFactorEnabled)
            <div class="space-y-4">
