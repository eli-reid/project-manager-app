<div x-data="{ open: @entangle('open') }" x-show="open" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div @click.away="open = false" class="bg-white dark:bg-zinc-900 rounded-lg shadow-lg w-full max-w-lg p-6">
        ...
        <form wire:submit.prevent="$parent.sendEmail">
            <div class="mb-4">
                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Recipient Email</label>
                <input type="email" wire:model.defer="$parent.emailForm.recipient" required class="mt-1 w-full rounded border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100" />
            ...
            <div class="mb-4">
                ...
                <input type="text" wire:model.defer="$parent.emailForm.subject" required class="mt-1 w-full rounded border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100" />
            ...
            <div class="mb-4">
                ...
                <textarea wire:model.defer="$parent.emailForm.body" rows="4" class="mt-1 w-full rounded border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-950 px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100"></textarea>
