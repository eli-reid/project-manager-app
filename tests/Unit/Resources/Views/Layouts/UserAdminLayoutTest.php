...
it('includes email management in the access admin domain navbar', function (): void {
    $view = file_get_contents(__DIR__.'/../../../../../app/Core/Identity/Resources/Views/livewire/layouts/access-admin.blade.php');
...
it('keeps user admin layout as a compatibility wrapper', function (): void {
    ...
    expect($view)->toContain("@include('core-user::livewire.layouts.access-admin')");
});
